...
Every virtue must have a name, description, and a value.
The value stores information about the virtuousness of the virtue.

Additionally, virtues may have a metric.
Metrics are programs that determine the virtuousness of a virtue and store that information in a virtue's value.
For the purposes of ease of use and flexibility, they should be programmed in Python 3.

Activities are a series of actions that affect traits.
They have a name, and a description of the activity.

Finally, there are two link classes that represent a relationship between virtues and activities.
The virtue-virtue link class represents the relationship between a virtue that is partially composed of another virtue.
The virtue-activity link class represents the relationship between a virtue that is related to an activity.
